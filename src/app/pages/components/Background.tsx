...
const Background = () => {
  return (
    <div className="fixed inset-0 -z-10 w-full h-screen overflow-hidden flex items-center justify-center bg-gradient-to-br from-blue-800 via-[#1E031F] to-black animate-gradient" //animete-gradient - cores de fundo mexe
    >
